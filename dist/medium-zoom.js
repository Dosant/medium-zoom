...
;(function(global, factory) {
  ...
  var mediumZoom = function mediumZoom(selector) {
    ...
    var _handleClick = function _handleClick(event) {
      ...
      var imageToToggle = images.find(function(image) {
        return image === target || image.contains(target)
      })
      if (!imageToToggle) {
        return
      }
      toggle({
        target: imageToToggle,
      })
    }
